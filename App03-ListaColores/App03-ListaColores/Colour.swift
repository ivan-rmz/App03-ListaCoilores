...
extension Colour {
    ...
    static let flatUI = [
        Alizarin, Amethyst, Asbestos, Asbestos, BelizeHole, Carrot, Clouds, Clouds, Concrete, Emerald, GreenSea, MidnightBlue, Nephritis, Orange, PeterRiver, Promegranate, Pumkin, Silver, SunFlower, Turquoise, WetAsphalt, Wisteria
    ]
